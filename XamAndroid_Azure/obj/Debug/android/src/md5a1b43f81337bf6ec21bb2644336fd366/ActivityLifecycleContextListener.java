package md5a1b43f81337bf6ec21bb2644336fd366;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.CurrentActivity.ActivityLifecycleContextListener, Plugin.CurrentActivity, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", ActivityLifecycleContextListener.class, __md_methods);
	}
	...
	public ActivityLifecycleContextListener ()
	{
		...
		if (getClass () == ActivityLifecycleContextListener.class)
			mono.android.TypeManager.Activate ("Plugin.CurrentActivity.ActivityLifecycleContextListener, Plugin.CurrentActivity, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
